...
if (!isset($_GET["import"])) {
    ...
    if (isset($rStream)) {
        foreach ((int) json_decode($rEPGSources[intval($rStream["epg_id"])]["data"], true) as $rKey => $rEPGChannel) {
            echo "                                                                    <option value=\"";
            echo $rKey;
            echo "\"";
    ...
    if (isset($rStream)) {
        foreach ((int) json_decode($rEPGSources[intval($rStream["epg_id"])]["data"], true)[$rStream["channel_id"]]["langs"] as $rID => $rLang) {
            echo "                                                                    <option value=\"";
            echo $rLang;
            echo "\"";
